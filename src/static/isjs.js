...
var LR_imgurl = 'https://dqt.zoosnet.net/';
var LR_c677b='5611703D7E1647BDBFABEC77F620696D';var LR_js_pm = 'd';
LR_c677b=((4+1).toString()+LR_c677b+(4*1).toString());LR_c677b=((4+2).toString()+LR_c677b+(4*2).toString());if(typeof(LR_showfloat)=='undefined')var LR_showfloat = 0;
var LiveReceptionCode_isonline = 0;
var LR_lng = 'cn';
var LR_websiteid = 'DQT25350602';
var LR_sysurl = 'https://dqt.zoosnet.net/';
var LR_siteid = '25350602';
var LR_isMobile = 0;
LR_c677b=LR_c677b.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_f9b1f=LR_c677b.replace(/1/g,'3').replace(/0/g,'2');var LR_MKEA=LR_f9b1f.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdqt.zoosnet.net%2flr%2fimages%2fonline_cn3.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdqt.zoosnet.net%2flr%2fimages%2foffline_cn3.gif");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&FOLE='+LR_MKEA;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="https://dqt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
